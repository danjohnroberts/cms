...
class courses_model extends CI_Model
{
    ...
    public function course_type($slug = FALSE)
    {
        ...
        $query = $this->db->order_by('cat_name', 'asc')->get_where('catagory', array(
            'crse_type' => $slug
        ));
    ...
    public function catagory($slug = FALSE)
    {
        ...
        $query = $this->db->get_where('courses', array(
            'cat_id' => $slug
        ));
    ...
    public function update_course($slug, $cat_id)
    {
        ...
        return $this->db->update('courses', $data, array(
            'url' => $slug
        ));
    }
    ///////////////////////////////////////////////////////////////////////
