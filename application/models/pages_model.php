...
Class pages_model extends CI_Model
{
    ...
    public function get_pages($slug = FALSE)
    {
        ...
        $query = $this->db->get_where('international_pages', array(
            'pages_catagories_id' => $slug
        ));
    ...
    public function get_page_catagory($url = FALSE)
    {
        ...
        $query = $this->db->get_where('international_pages_catagories', array(
            'id' => $url
        ));
    ...
    public function pages_count($international_pages_catagories_id = FALSE)
    {
        ...
        $query = $this->db->get_where('international_pages', array(
            'pages_catagories_id' => $international_pages_catagories_id
        ));
