<div class="row">
   <div class="panel">
      ...
      <br />
      <textarea class="mceEditor " id="description" name="description" rows="15" cols="80" style="width: 80%"><?php echo $description ;?></textarea>
      <br />
      <hr />
      ...
      <br />
      <textarea name="who"  class="mceEditor" rows="15" cols="80" style="width: 80%"><?php echo $who ;?></textarea>
      <br /> 
      <hr />
      <label for="text">Entry Requirements</label>
      <br />
      <textarea name="entry_requirements" rows="15" cols="80" style="width: 80%"><?php echo $entry_requirements ;?></textarea>
      <br />
      <hr />
      <label for="text">What you will Study</label>
      <br />
      <textarea name="what_study" class="mceEditor" rows="15" cols="80" style="width: 80%"><?php echo $what_study ;?></textarea>
      <br />
      <hr />
      <label for="text">How will I be assessed </label>
      <br />
      <textarea name="assessed" class="mceEditor" rows="15" cols="80" style="width: 80%"><?php echo $assessed ;?></textarea>
      <br />
      <hr />
      <label for="text">Where it can take you? </label>
      <br />
      <textarea name="where" class="mceEditor" rows="15" cols="80" style="width: 80%"><?php echo $where ;?></textarea>
      <br />
